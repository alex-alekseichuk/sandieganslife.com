...
function buildTop() 
{
  ...
  var imgPrevYear = "img/PrevYear.gif";
  var imgPrevMonth = "img/PrevMonth.gif";
  var imgNextMonth = "img/NextMonth.gif";
  var imgNextYear = "img/NextYear.gif";
