...
//	HTML parser
//
//	CHtml class for parsing text files: HTML, EMail, etc.
//
//		LoadTemplate($filename, $block_name) to load template form the file
//			returns 1-Ok, 0-Can't open
//		blockexists($block_name)
//			returns true if such block exists
//		setvar($key, $value)
//		parse($block_name = "", $accumulate = true)
//		parsesafe($block_name = "", $accumulate = true)
//
//
//
//	2006-03-10
...
class CHtml
{
  ...
  function CHtml($external_encoding = "", $out_encoding = "", $internal_encoding = "")
  {
